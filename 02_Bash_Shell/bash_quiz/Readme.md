...
Append the **line of text** that begins with `idcj` to your answers file.  

## 3) Find a File
Add a line to your answers file that reads `3)`  
In one of the directories in this quiz is a file called `keyboard_top100.txt`  
Find this file and append its **file path** to your answers file.
